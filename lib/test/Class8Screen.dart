          ...
          child: Column(
            ...
            children: [
              ...
              _buildQuestionCard(
                ...
                ['Кислород'],
                'Он играет ключевую роль в окислительно-восстановительных реакциях, таких как горение.'
              ),
              SizedBox(height: 20),
              _buildQuestionCard(
                context,
              ...
              _buildQuestionCard(
                context,
                'Вопрос 6:',
                'Как называется вещество, которое не может быть разложено на более простые вещества обычными химическими методами?',
